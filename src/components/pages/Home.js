  ...
  return (
    <div>
      <Segment basic inverted style={{ fontFamily: 'Roboto mono' }}>
        <h1 class="one column stackable ui grid centered huge header" style={{ fontFamily: 'Tourney' }}><b><u>Crystal Leung</u></b></h1>
        <h2 class="one column stackable ui grid centered"style={{fontFamily:'Zeyada'}}>Make Simple Web Design Accessible.</h2>
        <br /><br />
        <h2 class="one column stackable ui grid centered"> Hello this is<b>Crystal</b> <br/>a Frontend web developer and a Pharmacist</h2>
