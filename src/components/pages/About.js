        ...
        <div>
            <Segment basic inverted style={{ fontFamily: 'Roboto mono' }}>
                <Container text>
                    ...
                    <div class="ui people shape stackable grid container" style={{ display: 'flex', justifyContent: 'center' }}>
                        <div class="ui card" style={{ display: 'flex', justifyContent: 'center' }}>
                            <Image centered src={profile} style={{ opacity: '95%' }} ></Image>
                            <div class="extra content">Crystal Leung</div>
                    ...
                    <div class="ui divider"></div>
                        <div class="six wide computer column" style={{ fontFamily: 'Roboto mono', textAlign: 'center' }}>
                            <h1 style={{ color: '#E0E3EA' }}>Want to work together?</h1>
                                <h2>Let's have a chat_</h2>
                                <a style={{ position: 'relative', zIndex: '1' }} href="mailto:crystalpharma@gmail.com" target={"_blank"}><button class="ui teal inverted basic button">Email Me</button></a>
